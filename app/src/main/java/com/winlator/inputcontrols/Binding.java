...
public enum Binding {
    ...
    public String toString() {
        switch (this) {
            ...
            // DGPlayer's VPAD uses for the same actions. KEY_DGP_MOUSE_MODE is short for the same reason.
